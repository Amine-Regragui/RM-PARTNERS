        ...
        <CardContent className="pt-8 pb-8 text-center">
          <div className="flex justify-center mb-6">
            <div className="relative">
              ...
              <CircleAlert className="relative h-16 w-16 text-accent" />
            </div>
          </div>
          <h1 className="text-4xl font-bold text-heading mb-2">404</h1>
          <h2 className="text-xl font-semibold text-primary/80 mb-4">Page Not Found</h2>
