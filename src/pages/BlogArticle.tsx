...
export function BlogArticle() {
  const [n, i] = useRoute("/blog/:slug"),
    l = {
      "facturation-electronique-obligations": {
      ...
      "optimisation-fiscale-5-strategies": {
        ...
        <section className="py-20 md:py-32 bg-background">
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-3xl mx-auto mt-16 bg-secondary rounded-lg p-8 text-center">
              <h3 className="text-2xl font-bold mb-4 text-heading">Besoin d'aide ?</h3>
