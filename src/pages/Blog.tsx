  ...
  return (
    <div className="min-h-screen flex flex-col">
      <SEO
        ...
        description="Retrouvez les dernières actualités fiscales, comptables et sociales du cabinet RM Partners. Conseils d'experts pour votre entreprise."
      />
      <Header />
      <main className="flex-1">
        <section className="relative flex items-center rm-banner-hero">
          <div className="absolute inset-0 z-0 overflow-hidden">
            <img
              src="/actualites-banner.jpg"
              alt="Actualités RM Partners"
              className="w-full h-full object-cover rm-hero-img"
            />
            <div className="absolute inset-0 bg-primary/40" />
          </div>
          <div className="container mx-auto px-4 relative z-10">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 text-white">Actualités</h1>
            <p className="text-base md:text-xl text-white/90 max-w-2xl leading-relaxed">
              Retrouvez nos derniers articles, conseils et actualités sur la comptabilité, la
              ...
              {n.map((i, index) => (
                ...
                >
                  <CardHeader>
                    ...
                    <CardDescription>{i.excerpt}</CardDescription>
                  </CardHeader>
        ...
        <section className="py-20 md:py-32 bg-gradient-to-r from-primary to-primary/90 text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-4xl font-bold mb-6">Des questions sur ces sujets ?</h2>
