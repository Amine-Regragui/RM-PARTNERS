  ...
  return (
    ...
    >
      <div className="hidden lg:grid grid-cols-[auto_1fr_auto] items-center gap-4 px-6 xl:px-10 py-3">
          ...
          {u.map((p, index) => (
            <div key={index} className="relative group">
              {p.submenu ? (
                ...
                <Link
                  href={p.href}
                  className="text-sm text-foreground hover:text-accent transition-colors font-medium py-2 inline-block whitespace-nowrap"
                >
                  {p.label}
                </Link>
              )}
        ...
        <Link href="/contact" className="rm-arrow-cta flex-shrink-0">
          Nous contacter
      ...
      {n && (
        <nav className="lg:hidden bg-white border-t border-border shadow-xl">
          <div className="px-4 py-4 flex flex-col gap-3">
            ...
            <Link
              href="/contact"
              className="rm-arrow-cta justify-center mt-2"
              onClick={() => i(!1)}
            >
              Nous contacter
              <span className="rm-arrow-circle">
